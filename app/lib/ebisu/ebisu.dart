...
///
/// In a nutshell, it works by modelling the probability that a fact will be remembered correctly at any arbitrary
/// moment since the last time the fact was last quizzed.
///
...
import 'package:papageno/ebisu/mingolden.dart';
...
@immutable
class EbisuModel {
  /// The time since last review (in unspecified units) for which the Beta distribution models the recall probability.
  final double time;
